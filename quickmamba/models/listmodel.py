...
class QObjectListModel(QtCore.QAbstractListModel):
    ...
    def insert(self, i, toInsert):
        ...
        any views. If i is 0, the object is prepended to the model.
        If is size(), the object is appended to the list.
        Accepts both QObject and list of QObjects.
        """
    ...
    def removeAt(self, i, count=1):
        ...
        i must be a valid index position in the model (i.e., 0 <= i < size()), as must as i + count - 1.
        """
